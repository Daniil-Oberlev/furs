...
export const AboutSection = () => {
  return <section id="about" className="py-16 bg-stone-800">
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <TypographyP className="text-stone-300 mb-8 text-2xl">
          Более 25 лет мы создаем шубы исключительного качества для самых взыскательных клиентов. Наш бренд —
          это
          синоним роскоши, элегантности и безупречного стиля.
        </TypographyP>
