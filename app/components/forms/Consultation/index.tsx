      ...
      <DialogContent className="bg-white border-stone-300 text-stone-800 max-w-md">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="cons-name" className="text-stone-800 mb-2 block">
                Имя *
              </Label>
              <Input
                id="cons-name"
            ...
            <div>
              <Label htmlFor="cons-phone" className="text-stone-800 mb-2 block">
                Телефон *
              </Label>
              <Input
                id="cons-phone"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="cons-date" className="text-stone-800 mb-2 block">
                  Дата
                </Label>
                <Input
                  id="cons-date"
