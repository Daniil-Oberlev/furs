...
export default function Loading() {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-stone-100 via-stone-50 to-amber-50">
      <div className="text-center">
        <div className="mb-8 relative">
          <div className="animate-pulse">
            <Crown className="h-16 w-16 text-amber-700 mx-auto mb-4 animate-bounce"/>
          </div>
          <h1 className="text-4xl font-playfair font-bold text-stone-800 tracking-wider">{COMPANY_NAME}</h1>
          <p className="text-base font-cormorant text-stone-600 mt-2 tracking-widest uppercase">Эксклюзивные
            шубы</p>
        </div>
