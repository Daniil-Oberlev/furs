          ...
          <div>
            ...
            <div className='space-y-4 text-lg font-cormorant text-stone-600 leading-relaxed'>
              <TypographyP>
                ...
                красоте в её самой утончённой форме. О том, как роскошь может быть тихой, уверенной,
                осознанной. Бренд основан всего четыре года назад, но уже стал узнаваемым среди
                ценителей настоящей элегантности. Наши изделия представлены в ЦУМе — одном из
                главных модных пространств Москвы, что стало естественным продолжением пути, который
                мы выбрали.
              </TypographyP>
              <TypographyP>
                ...
                мире — из Баргузинского заповедника. Его блеск, плотность и фактура — эталон, перед
                которым невозможно устоять. Но границы нашей эстетики шире. Мы создаём изделия и из
                других благородных мехов: норки, лисы, каракуля, куницы, а также используем отборные
                материалы — кашемир, шёлк, гипюр, замшу. Всё, что наделено изяществом, фактурой и
                характером. Мы соединяем ремесленные традиции с современным взглядом, чтобы
                создавать не просто одежду — вневременные ценности.
              </TypographyP>
              <TypographyP>
                {COMPANY_NAME} — это антипод быстрой моды. Мы не гонимся за трендами, мы создаём
                стиль. Тот, который не подвержен шуму и суете, тот, что звучит тише — но глубже. Наш
                девиз — «Позвольте себе роскошь без правил» Для нас важна не только форма, но и
                суть. Мы создаём изделия как арт-объекты, с вниманием к каждой строчке, каждой
              ...
              <TypographyP>
                ...
                вернуть к жизни давно любимую вещь. Мы бережно трансформируем устаревшие шубы, даём
                им новое дыхание, новый силуэт, новое лицо. Это больше, чем перешив — это
