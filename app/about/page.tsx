      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <TypographyH2 className="text-4xl font-playfair font-light text-stone-800 mb-6">Наша история</TypographyH2>
              <div className="space-y-4 text-lg font-cormorant text-stone-600 leading-relaxed">
                <TypographyP>
                  {COMPANY_NAME} был основан в 1999 году с простой, но амбициозной целью — создавать самые
                  красивые и
                  качественные шубы в России. Начав с небольшой мастерской, мы выросли в признанный
                  бренд
                  премиум-класса.
                </TypographyP>
                <TypographyP>
                  Наша философия основана на трех принципах: безупречное качество материалов,
                  мастерство исполнения и
                  индивидуальный подход к каждому клиенту. Мы работаем только с лучшими поставщиками
                  меха и используем
                  традиционные техники пошива.
                </TypographyP>
                <TypographyP>
                  Сегодня {COMPANY_NAME} — это символ роскоши и элегантности, выбор тех, кто ценит качество
                  и неповторимый
                  стиль.
                </TypographyP>
              </div>
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {ACHIEVEMENTS.map((achievement, index) => (
              <Card key={index} className="bg-white border-stone-200 text-center p-6 shadow-sm">
                <CardContent className="p-0">
                  <achievement.icon className="h-12 w-12 text-amber-700 mx-auto mb-4"/>
                  <TypographyH3 className="text-2xl font-playfair font-medium text-stone-800 mb-2">{achievement.title}</TypographyH3>
                  <TypographyP className="text-xl font-cormorant text-stone-600">{achievement.description}</TypographyP>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {TEAM_MEMBERS.map((member, index) => (
              <Card key={index} className="bg-white border-stone-200 text-center shadow-sm">
                <CardContent className="p-6">
                  ...
                  <TypographyH3 className="text-2xl font-playfair font-medium text-stone-800 mb-1">{member.name}</TypographyH3>
                  <TypographyP className="text-xl font-cormorant text-amber-700 mb-2">{member.position}</TypographyP>
                  <TypographyP className="text-base font-inter text-stone-600">{member.experience}</TypographyP>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section className="text-center mb-16">
          <div className="bg-stone-50 rounded-lg p-12">
            <TypographyH2 className="text-4xl font-playfair font-light text-stone-800 mb-6">Посетите наш салон</TypographyH2>
