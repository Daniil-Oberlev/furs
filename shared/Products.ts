...
export const productData: IProductData = {
  1: {
    ...
    description: "Длинную шубу сшили из перфорированного меха норки. На нем вручную сымитировали арановую вязку, искусно вырезав детали из меха американской норки по эскизам художников. Модель на шелковом подкладе застегивается потайными крючками.",
    details: {
  ...
  2: {
    ...
    description: 'Для пошива шубы с потайной застежкой использовали каракуль скавара с характерным муаровым рисунком и деликатным блеском. Внутри – подклад из шелкового атласа в тон. По бокам предусмотрели карманы и высокие разрезы.',
    details: {
  ...
  3: {
    ...
    description: 'Клетчатую шубу со спущенной линией плеч и круглым вырезом сшили из меха норки, которому придали рифленую фактуру. Модель с потайной застежкой и боковыми карманами дополнили широким парным шарфом с длинной бахромой на концах.',
    details: {
      material: 'Мех/норка/: 100%',
      lining: 'Подкладка-шелк: 100%',
      origin: 'Россия',
    ...
    purchaseLink: 'https://www.tsum.ru/product/he00905745-shuba-iz-mekha-norki-sablefur-raznotcvetnyi/'
  }
}
