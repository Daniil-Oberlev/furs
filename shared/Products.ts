...
const rawProductData = {
  ...
  2: {
    ...
    images: [
      ...
      {
        src: 'https://st-cdn.tsum.com/sig/d464a09db4c4c081c42931264de9bc38/width/763/i/78/73/6b/bc/aad6aebc-8c9e-4edd-a54b-46f03320cb12.jpg',
        alt: 'Шуба из свакары'
      }
    ],
    description:
...
export const productData: ProductData = validateAndTransformProducts(rawProductData)
